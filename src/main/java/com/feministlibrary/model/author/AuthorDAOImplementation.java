    ...
    public class AuthorDAOImplementation implements AuthorDAOInterface {
        ...
        private Author buildAuthorFromResultSet(ResultSet rs) throws SQLException {
            Author author = new Author(rs.getInt("id"), rs.getString("name"), rs.getString("last_name"));
            return author;
        }
        ...
        public Author getById(int idAuthor) {
            ...
            try (Connection conn = DBManager.getConnection();
                ...
                try (ResultSet rs = stmt.executeQuery()) {
                    if (rs.next()) return buildAuthorFromResultSet(rs);
                }
        ...
        public List<Author> getAll() {
            ...
            try (Connection conn = DBManager.getConnection();
                ...
                while (rs.next()) authors.add(buildAuthorFromResultSet(rs));
